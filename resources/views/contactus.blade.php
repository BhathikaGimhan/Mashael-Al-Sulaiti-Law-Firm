...
@section('title', 'Mashael Alsulaiti Law Firm | Contact Us')
@section('content')
    ...
    <!-- Contact form-->
    <section class="container pb-5" style="margin-top: -80px;">
        <div class="card border-0 position-relative py-lg-4 py-xl-5">
            ...
            <div class="card-body position-relative zindex-2 py-5">
                <form class="mx-auto" method="POST" action="{{ route('contact.us.store') }}" id="contactUSForm"
                    style="max-width: 800px;">
                    {{ csrf_field() }}
                    <h2 class="h1 card-title text-center pb-4">Get a consultation</h2>
                    <div class="row g-4">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control form-control-lg" type="text" placeholder="Subject" id="subject"
                        ...
                        <div class="col-sm-12 text-center pt-4">
                            <button class="btn btn-lg btn-dark btn-submit" type="submit">Submit</button>
                        </div>
                    </div>
                </form>
