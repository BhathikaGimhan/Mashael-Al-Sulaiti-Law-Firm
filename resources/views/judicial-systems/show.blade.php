...
<section class="container pt-5 mt-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="pt-lg-3 pb-lg-4 pb-2 breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/judicial-systems">Judicial Systems</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{$judicialSystem->title}}</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-lg-9 col-xl-8 pe-lg-4 pe-xl-0">
            <!-- Post title + post meta-->
            <h1 class="pb-2 pb-lg-3">{{$judicialSystem->title}}</h1>
            <div class="d-flex flex-wrap align-items-center justify-content-between border-bottom mb-4">
                <div class="d-flex align-items-center mb-4 me-4"><span class="fs-sm me-2">By:</span><a class="nav-link position-relative fw-semibold p-0" href="#author" data-scroll data-scroll-offset="80">{{$judicialSystem->createdBy->name}}<span class="d-block position-absolute start-0 bottom-0 w-100" style="background-color: currentColor; height: 1px;"></span></a></div>
            ...
            <div class="fs-lg pt-2 pt-sm-3">{!! $judicialSystem->description !!}</div>
            <!-- Post content-->
            <figure class="figure">
                <img class="figure-img rounded-5 mb-3" src="{{$judicialSystem->image}}" alt="Image">
                <!-- <figcaption class="figure-caption">Image source tristique justo et pharetra</figcaption> -->
            </figure>
            <div class="fs-lg pt-2 pt-sm-3">{!! $judicialSystem->content !!}</div>
            <!-- Author widget-->
                ...
                <div class="d-flex align-items-start py-2"><img class="d-block rounded-circle mb-3" src="assets/img/avatar/04.jpg" width="56" alt="Author image">
                    <div class="d-md-flex w-100 ps-4">
                        <div style="max-width: 26rem;">
                            <h3 class="h5 mb-2">{{$judicialSystem->createdBy->name}}</h3>
                            <p class="fs-sm mb-0">{{$judicialSystem->createdBy->summary}}</p>
                        </div>
...
<section class="container py-5 mt-sm-2 my-md-4 my-xl-5">
    <div class="d-flex align-items-center pb-3 mb-3 mb-lg-4 mt-2 mt-xxl-3">
        <h2 class="h1 mb-0 me-4">Related Judicial Systems</h2>
...
">
        <div class="swiper-wrapper">
            @foreach ($relatedSystems as $relatedSystem)
            <!-- Post-->
            <article class="swiper-slide">
                <div class="position-relative"><img class="rounded-5" src="{{$relatedSystem->image}}" alt="Post image">
                    <h3 class="h4 mt-4 mb-0"><a class="stretched-link" href="/judicial-system/{{$relatedSystem->slug}}">{{$relatedSystem->title}}</a></h3>
                </div>
            </article>
            @endforeach
        </div>
