...
@section('title', 'Mashael Alsulaiti Law Firm | Edit Vacancy')
@section('content')
    <div class="d-flex justify-content-between">
        <h1>{{ __('Edit Vacancy') }}</h1>
        <div class="">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="position" type="text" class="form-control @error('position') is-invalid @enderror"
                            name="position" value="{{ old('position', $vacancy->position) }}" required autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="opening_date" type="date"
                            ...
                            value="{{ old('opening_date', $vacancy->opening_date) }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="closing_date" type="date"
                            ...
                            value="{{ old('closing_date', $vacancy->closing_date) }}" required>
