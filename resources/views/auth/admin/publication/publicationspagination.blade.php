<div class="ms-4 mt-3">
    <nav aria-label="Page navigation">
        <ul class="pagination">
            ...
            @else
                <li class="page-item">
                    <a class="page-link" href="{{ $publications->previousPageUrl() }}" tabindex="-1"><i
                            class="ai-arrow-left"></i></a>
                </li>
            @endif

            @foreach ($publications->getUrlRange(1, $publications->lastPage()) as $page => $url)
                <li class="page-item{{ $page === $publications->currentPage() ? ' active' : '' }}">
            ...
            @if ($publications->hasMorePages())
                <li class="page-item">
                    <a class="page-link" href="{{ $publications->nextPageUrl() }}"><i class="ai-arrow-right"></i></a>
                </li>
            @else
                <li class="page-item disabled">
