...
@section('content')
    ...
    <section class="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4 mb-4">
        <div class="card-body">
            <form action="/manage/publications" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mt-2">
                                    ...
                                    <input id="file-thumbnail" class="form-control" type="text"
                    ...
                    <input type="text" class="d-none" name="publication_file_path" value="none">
                    ...
                    <div class="div">
                        <div class="row">
                            <div class="col-6">
                                <button class="btn btn-success mt-2 mb-2 mb-sm-0" type="submit">Submit Publication</button>
                            </div>
                        </div>
                    </div>
                </div>
